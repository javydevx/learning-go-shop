...
import (
	...
	"github.com/javydevx/learning-go-shop/internal/dto"
	"github.com/javydevx/learning-go-shop/internal/models"
	"github.com/javydevx/learning-go-shop/internal/utils"
	"gorm.io/gorm"
)
...
func (s *AuthService) Register(req *dto.RegisterRequest) (*dto.AuthResponse, error) {
	...
	if err := s.db.Create(&cart); err != nil {
